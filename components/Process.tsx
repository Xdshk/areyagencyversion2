...
export default function Process() {
  return (
    <section className="mx-auto w-full max-w-7xl px-6 py-20 md:px-10">
      ...
      >
        <motion.h2 variants={fadeUp} className="font-editorial col-span-full text-3xl font-semibold tracking-[-0.02em] md:text-5xl">
          Процесс
        </motion.h2>
        {steps.map((step) => (
          <motion.article
            ...
            className="rounded-2xl border border-white/10 px-6 py-7 transition-colors duration-300 hover:border-zinc-500/35"
          >
            <p className="text-xs tracking-[0.2em] text-zinc-500">{step.id}</p>
