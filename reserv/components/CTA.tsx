...
export default function CTA() {
  return (
    <section className="mx-auto w-full max-w-7xl px-6 pb-24 pt-10 md:px-10">
      ...
      >
        <motion.h2 variants={fadeUp} className="text-4xl font-semibold tracking-tight md:text-6xl">
        ...
        <motion.div variants={fadeUp} className="mt-8 flex flex-wrap items-center justify-center gap-4">
          ...
          <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.98 }}>
            <Link
              href="/contact"
              className="inline-block rounded-full bg-fuchsia-400 px-6 py-3 text-sm font-medium text-black transition-colors hover:bg-fuchsia-300"
            >
              Начать проект
            </Link>
          </motion.div>
