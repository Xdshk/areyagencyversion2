...
export default function Benefits() {
  return (
    <section className="mx-auto w-full max-w-7xl px-6 py-20 md:px-10">
      ...
      >
        <motion.h2 variants={fadeUp} className="col-span-full max-w-3xl text-3xl font-semibold tracking-tight md:text-5xl">
          Почему выбирают нас
        </motion.h2>
        ...
        {benefits.map((item) => (
          <motion.article
            ...
            className="rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-[box-shadow] duration-300 hover:border-fuchsia-500/20 hover:shadow-lg hover:shadow-fuchsia-500/5"
          >
